...
void cardEffectHelper(struct gameState *state)
{
    int i;
    int j;
    int k;
...
int cardEffectTrubute(struct gameState *state)
{
        cardEffectHelper(state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    {
    case baron:
        return cardEffectBaron(choice1, state);
    case minion:
        return cardEffectMinion(choice1 choice2, state, handPos);
    case ambassador:
        return cardEffectAmbassador(choice1, choice2, state, handPos);
    case tribute:
        return cardEffectTribute(state);
    case mine:
    ...
    case tribute:
	return cardEffectTribute();

    case ambassador:
	return cardEffectAmbassador();
